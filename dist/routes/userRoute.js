...
router.get('/profile', auth_1.userMiddleware, async (req, res) => {
    try {
...
// Update user profile
router.put('/profile', auth_1.userMiddleware, async (req, res) => {
    try {
        //@ts-expect-error: no need here
        const userId = req.user.id;
...
// Delete user account
router.delete('/profile', auth_1.userMiddleware, async (req, res) => {
    try {
        //@ts-expect-error: no need here
        const userId = req.user.id;
